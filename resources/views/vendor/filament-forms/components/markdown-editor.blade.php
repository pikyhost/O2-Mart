...
<x-dynamic-component :component="$fieldWrapperView" :field="$field">
 ...
 >
 <!-- Header Extensions -->
 <div id="header-extensions-{{ $id }}" style="display: none;">
 <div class="header-toolbar">
 <button type="button" class="header-btn" onclick="insertHeader('h2', '{{ $id }}')" title="Heading 2">
 <span class="header-text">H2</span>
 </button>
 <button type="button" class="header-btn" onclick="insertHeader('h3', '{{ $id }}')" title="Heading 3">
 <span class="header-text">H3</span>
 </button>
 <button type="button" class="header-btn" onclick="insertHeader('h4', '{{ $id }}')" title="Heading 4">
 ...
 <div id="color-picker-extension-{{ $id }}" style="display: none;">
 <div class="color-palette">
 <div class="color-btn" onclick="applyColor('#ef4444', '{{ $id }}')" title="Red" style="background: #ef4444"></div>
 <div class="color-btn" onclick="applyColor('#f97316', '{{ $id }}')" title="Orange" style="background: #f97316"></div>
 <div class="color-btn" onclick="applyColor('#eab308', '{{ $id }}')" title="Yellow" style="background: #eab308"></div>
 <div class="color-btn" onclick="applyColor('#22c55e', '{{ $id }}')" title="Green" style="background: #22c55e"></div>
 <div class="color-btn" onclick="applyColor('#3b82f6', '{{ $id }}')" title="Blue" style="background: #3b82f6"></div>
 <div class="color-btn" onclick="applyColor('#8b5cf6', '{{ $id }}')" title="Purple" style="background: #8b5cf6"></div>
 <div class="color-btn" onclick="applyColor('#ec4899', '{{ $id }}')" title="Pink" style="background: #ec4899"></div>
 <div class="color-btn" onclick="applyColor('#6b7280', '{{ $id }}')" title="Gray" style="background: #6b7280"></div>
 ...
 <input type="color" onchange="applyColor(this.value, '{{ $id }}')">
 </label>
 </div>
 </div>
...
uploadFileAttachmentUsing: async (file, onSuccess, onError) => {
  try {
    ...
    const res = await fetch('{{ route('filament.admin.blogs.upload-attachment') }}', {
      method: 'POST',
      body: formData,
 ...
 x-init="setTimeout(() => { initializeExtensions('{{ $id }}'); setTimeout(() => { const editor = getEditorInstance('{{ $id }}'); if (editor && editor.codemirror) { renderColoredText(editor.codemirror); renderImages(editor.codemirror); } }, 1500); }, 1000)"
 wire:ignore
