...
use App\Filament\Resources\InstallerShopResource\Pages;
use App\Filament\Resources\InstallerShopResource\Pages\ManageInstallerShopWorkingHour;
use App\Models\Day;
...
class InstallerShopResource extends BaseResource
{
    ...
    public static function getRecordSubNavigation(Page $page): array
    {
        return $page->generateNavigationItems([
           Pages\EditInstallerShop::class,
            ManageInstallerShopWorkingHour::class,
        ]);
    }
                                    ...
                                    ->loadStateFromRelationshipsUsing(function (Repeater $component): void {
                                        ...
                                        $component->state(
                                            $groupedRecords->map(function (Collection $group) {
                                                $first = $group->first();
                                                return [
                                                    'day_ids' => $group->pluck('day_id')->sort()->values()->toArray(),
    ...
    {
        return [
            'index' => Pages\ListInstallerShops::route('/'),
            'create' => Pages\CreateInstallerShop::route('/create'),
            'edit' => Pages\EditInstallerShop::route('/{record}/edit'),
            'workingHours' => ManageInstallerShopWorkingHour::route('/{record}/working-hours'),
        ];
    }
}
