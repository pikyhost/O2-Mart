...
class BatteryPolicy
{
    ...
    {
        return $user->can('view_any_battery');
    }
    ...
    {
        return $user->can('create_battery');
    }
    ...
    {
        return $user->can('update_battery');
    }
    ...
    {
        return $user->can('delete_battery');
    }
    ...
    {
        return $user->can('delete_any_battery');
    }
     ...
     */
    public function replicate(User $user, Battery $battery): bool
    {
