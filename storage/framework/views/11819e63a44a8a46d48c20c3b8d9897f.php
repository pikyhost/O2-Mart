...
<div class="mx-auto max-w-7xl px-6 py-4 flex flex-col items-center md:items-start lg:px-8">
    <div class="text-center md:text-left">
        <p class="text-sm leading-5 footer-text">
            <?php echo e(__($footerTexts[$locale]['rights'], ['name' => $siteName, 'year' => now()->year])); ?>

        </p>
        <p class="text-sm leading-5 footer-text">
            <?php echo e(__($footerTexts[$locale]['made_with'])); ?>
...
<?php /**PATH /home/mo/code/laravel/o2-mart-back/resources/views/footer.blade.php ENDPATH**/ ?>